...
async function startUpload(file) {
    ...
    reader.onloadend = async () => {
        ...
        const apiUrl = `https://api.github.com/repos/${GITHUB_USERNAME}/${GITHUB_REPO_NAME}/contents/IMG/${fileName}`;
        const data = {
        ...
        try {
            ...
            if (response.ok) {
                const githubPagesUrl = `https://sadulursepoor.web.id/IMG/${fileName}`;
