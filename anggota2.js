...
// Fungsi Menampilkan Notifikasi Tambah Foto - DIUBAH
    ...
    confirmationBox.innerHTML = `
        <div class="confirmation-content">
            ...
            <div class="confirmation-buttons">
                ...
                <button class="confirm-button" onclick="redirectToLogin('${name}', '${kta}')">Lanjut</button>
            </div>
        </div>
    `;
...
// Fungsi Mengarahkan ke Halaman Login - DIUBAH
function redirectToLogin(name, kta) {
    // Simpan data anggota di localStorage untuk digunakan di halaman login
